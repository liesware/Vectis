    ...
    sections: &[
        ...
        HelpSection {
            ...
            lines: &[
                ...
                "  build_status          Current build maturity status",
                "  version               Cargo package version",
                "  protocol_version      Supported Vectis protocol version",
                "  license               Cargo package license identifier",
                "  copyright             Original project copyright notice",
                "  project               Official project repository",
                "  profiles              Supported key generation profiles",
                "  capabilities          Implemented public cryptographic capabilities",
            ],
        },
    ],
    output: true,
