...
| `VECTIS_APIKEY_HASH` | Empty string | 32-byte HMAC-SHA256 value encoded as 64 hex characters | Server-side API key verifier generated by `vectis init`. Protected endpoints require this value. |
